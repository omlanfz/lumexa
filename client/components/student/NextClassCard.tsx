...
interface UpcomingBooking {
  ...
  // 'lesson' = generated by Operations' recurring schedule (no live
  // classroom room yet — the teacher starts it from their own dashboard).
  // 'booking' = a marketplace-booked shift with a real classroom/egress.
  ...
  return (
    <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800/30 rounded-xl p-6 h-full card-hover">
      ...
      {booking.source === 'lesson' ? (
        <div className="mt-5 px-3 py-2.5 rounded-lg bg-teal-100/50 dark:bg-teal-900/20 text-teal-700 dark:text-teal-300 text-xs">
          Your teacher will start this class from their dashboard when it's time.
        </div>
      ) : (
