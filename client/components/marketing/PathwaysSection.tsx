...
const pathways: Pathway[] = [
  ...
  },
  {
    ...
    outcome: "Identity to Opportunity",
    description:
      "Build the portfolio, professional skills, digital reputation and business knowledge needed to turn real abilities into legitimate opportunities — the honest, age-appropriate way.",
    tools: ["Canva", "Google Docs", "LinkedIn (16+)", "GitHub / Vercel"],
    ages: "Ages 15–18",
    sessions: "24 sessions",
    level: "Identity to Opportunity",
    projects: ["Live portfolio + brand kit + case studies", "Priced service package + simulated client project", "Professional presence + 90-day opportunity plan"],
