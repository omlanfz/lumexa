    ...
    <section className="py-24 bg-gradient-to-b from-[#080F20] to-[#050D1A] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-gray-400 mb-10 max-w-xl mx-auto">
          Join 1,200+ families already on Lumexa. Start with a free trial — no
          commitment, no credit card. If it's not a perfect fit, you owe nothing.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            href="/trial"
            className="px-8 py-4 text-base font-bold bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-xl shadow-2xl shadow-purple-900/50 hover:shadow-purple-700/60 transition-all transform hover:scale-[1.03] active:scale-95"
          >
