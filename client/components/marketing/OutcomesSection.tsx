...
const outcomes = [
  ...
  },
  {
    ...
    emoji: "🧠",
    description: "Coding rewires how kids think. Your child will approach any problem — in school, at home, in life — with structured, logical thinking.",
