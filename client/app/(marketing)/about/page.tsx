    ...
    <div className="bg-[#F7F9FF] dark:bg-[#050D1A] text-[#0F172A] dark:text-white transition-colors duration-200">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-purple-300/20 dark:bg-purple-700/10 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-300/15 dark:bg-blue-700/8 rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#334155] dark:text-gray-400 max-w-2xl mx-auto leading-relaxed mb-8">
          ...
          <p className="text-[#64748B] dark:text-gray-500 max-w-xl mx-auto text-base leading-relaxed">
      ...
      {/* Stats */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 border-y border-[#E2E8F0] dark:border-gray-800/60">
        <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 text-center">
          {stats.map((s) => (
            <div key={s.label}>
              <div className="text-3xl font-black text-[#0F172A] dark:text-white mb-1">{s.value}</div>
              <div className="text-xs text-[#64748B] dark:text-gray-500">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-purple-600 dark:text-purple-400 text-sm font-bold uppercase tracking-widest mb-3">The Story</p>
              <h2 className="text-3xl font-black mb-6 leading-tight">Why Lumexa Exists</h2>
              <div className="space-y-4 text-[#334155] dark:text-gray-400 leading-relaxed">
                <p>
                ...
                <p>
                  Lumexa started with a simple belief:{" "}
                  <span className="text-[#0F172A] dark:text-white font-semibold">
                    the best way to learn is by building something real, with a real teacher who knows your name.
                  </span>
                </p>
                <p>
            ...
            <div className="space-y-4">
              {[
                {
                  label: "The Problem",
                  text: "Generic, passive, pre-recorded content that doesn't adapt to the child.",
                  light: "border-red-200 bg-red-50",
                  dark: "dark:border-red-700/40 dark:bg-red-900/10",
                  labelColor: "text-red-600 dark:text-red-400",
                },
                {
                  label: "Our Solution",
                  text: "Live classes with expert teachers (batch, 1-on-1, and group formats). Every lesson adapted to your child's pace, goals, and personality.",
                  light: "border-green-200 bg-green-50",
                  dark: "dark:border-green-700/40 dark:bg-green-900/10",
                  labelColor: "text-green-600 dark:text-green-400",
                },
                {
                  label: "The Outcome",
                  text: "A real portfolio of projects. Skills that will matter in 2030 and beyond. A child who builds, not just consumes.",
                  light: "border-purple-200 bg-purple-50",
                  dark: "dark:border-purple-700/40 dark:bg-purple-900/10",
                  labelColor: "text-purple-600 dark:text-purple-400",
                },
              ].map((item) => (
                <div key={item.label} className={`p-5 rounded-xl border transition-all card-hover ${item.light} ${item.dark}`}>
                  <div className={`text-xs font-bold uppercase tracking-wider mb-2 ${item.labelColor}`}>{item.label}</div>
                  <p className="text-sm text-[#334155] dark:text-gray-300 leading-relaxed">{item.text}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Values */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#07101F] transition-colors duration-200">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-purple-600 dark:text-purple-400 text-sm font-bold uppercase tracking-widest mb-3">What We Believe</p>
            <h2 className="text-3xl font-black">Our Principles</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v) => (
              <div
                key={v.title}
                className="p-6 bg-[#F7F9FF] dark:bg-gray-900/50 border border-[#E2E8F0] dark:border-gray-800 rounded-2xl card-hover group"
              >
                <div className="text-3xl mb-4 group-hover:scale-110 transition-transform duration-200">{v.icon}</div>
                <h3 className="font-bold mb-2 text-[#0F172A] dark:text-white">{v.title}</h3>
                <p className="text-[#64748B] dark:text-gray-400 text-sm leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-purple-600 dark:text-purple-400 text-sm font-bold uppercase tracking-widest mb-3">The People</p>
            <h2 className="text-3xl font-black">Who Builds Lumexa</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {team.map((t) => (
              ...
              >
                ...
                <p className="text-[#64748B] dark:text-gray-400 text-sm leading-relaxed">{t.bio}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#07101F] transition-colors duration-200">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-black mb-4">Ready to See the Difference?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/trial"
              className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-black rounded-xl shadow-xl shadow-purple-200 dark:shadow-purple-900/40 transition-all hover:scale-[1.02]"
            >
            ...
            <Link
              href="/courses"
              className="px-8 py-4 text-sm font-semibold text-[#334155] dark:text-gray-400 hover:text-[#0F172A] dark:hover:text-white border border-[#E2E8F0] dark:border-gray-700 hover:border-purple-200 dark:hover:border-gray-500 rounded-xl transition-all"
            >
              Explore All Courses →
            </Link>
          </div>
