          ...
          <div className="max-w-4xl mx-auto space-y-6 fade-in">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 stagger-children">
              {statCards.map((s) => (
                <div
                  key={s.label}
                  className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4 text-center fade-in card-hover"
                >
            ...
            {!isTeacherView && (
              <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-900/20 to-teal-900/20 border border-gray-700/50">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-semibold text-sm transition-all duration-200 active:scale-[0.98] shadow-lg shadow-blue-500/20"
                >
                  Find a Teacher 🔭
                </button>
              </div>
              ...
              <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-5">
                ...
                <div className="space-y-3">
                  {upcomingBookings.slice(0, 3).map((b) => (
                    <div
                      key={b.id}
                      className="flex items-center gap-3 p-3 rounded-xl bg-blue-900/20 border border-blue-700/30 card-hover"
                    >
              ...
              <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-5">
                ...
                <div className="space-y-3">
                  {recentCompleted.map((b) => (
                    <div
                      key={b.id}
                      className="flex items-center gap-3 p-3 rounded-xl bg-green-500/10 border border-green-500/20 card-hover"
                    >
            ...
            {bookings.length === 0 && (
              <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-10 text-center">
                ...
                {!isTeacherView && (
                  <button
                    onClick={() => router.push(`/marketplace?studentId=${studentId}`)}
                    className="mt-4 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-sm font-medium transition-all duration-200 active:scale-[0.98]"
                  >
                    Browse Teachers
                  </button>
                )}
            ...
            {upcomingBookings.length === 0 ? (
              <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-10 text-center">
                ...
                {!isTeacherView && (
                  <button
                    onClick={() => router.push(`/marketplace?studentId=${studentId}`)}
                    className="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm transition-all duration-200 active:scale-[0.98]"
                  >
                    Book a Class
                  </button>
                )}
              ...
              <div className="space-y-3">
                {upcomingBookings.map((b) => (
                  <div
                    key={b.id}
                    className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4 flex items-center gap-4 card-hover"
                  >
